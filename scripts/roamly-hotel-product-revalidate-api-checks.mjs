...
const baseDeps = {
  ...
  loadSelectedHotelActionContext: async (_supabase, trip, itinerary, bookings) => { calls.context++; assert.equal(trip, trustedTrip); assert.equal(itinerary, null); assert.deepEqual(bookings, []); return trustedContext; },

...
import { customerTripLifecycleState, dedupeEquivalentNotifications, isCustomerTripTerminalState, notificationActionState } from "../lib/roamly/liveCompanion.ts";
...
const archivedProductionShape = {
  status: "archived",
  itineraryStatus: "generated",
  startDate: "2026-08-05",
  endDate: "2026-08-08",
  metadata: { planning: { startDate: "2026-08-05", endDate: "2026-08-08", timezone: "America/Toronto" } }
};
...
assert.equal(customerTripLifecycleState(archivedProductionShape, "2026-09-26T12:00:00Z"), "archived");
assert.equal(isCustomerTripTerminalState(customerTripLifecycleState(archivedProductionShape, "2026-09-26T12:00:00Z")), true);

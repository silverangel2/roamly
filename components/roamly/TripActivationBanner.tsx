...
export function TripActivationBanner({
  ...
  return (
    <section className="overflow-hidden rounded-[2rem] bg-ink p-5 text-white shadow-soft sm:p-6">
      <div className="absolute -right-14 -top-14 h-40 w-40 rounded-full bg-ocean/30 blur-3xl" />
      <div className="relative">
        <p className="text-xs font-black uppercase tracking-[0.18em] text-white/55">Roamly notification</p>
        <h1 className="mt-2 text-4xl font-black tracking-tight sm:text-6xl">
          {notification?.title || "Live Trip Companion ready"}
        </h1>
        <p className="mt-3 text-lg font-black text-ocean">Day {dayNumber || 1}</p>

...
export default async function AdminLaunchPage() {
  ...
  const checks: LaunchCheck[] = [
    ...
    ["Social cron configuration", "Ready", "Vercel cron calls /api/cron/roamly-social-autopost."],
    ["Social cron secret", configured(social.env.cronSecretConfigured), "Set ROAMLY_SOCIAL_CRON_SECRET in production."],
    ["Itinerary generation cron", configured(Boolean(process.env.ROAMLY_GENERATION_CRON_SECRET || process.env.CRON_SECRET)), "Set ROAMLY_GENERATION_CRON_SECRET or CRON_SECRET before release."],

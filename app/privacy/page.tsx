...
const sections = [
  ...
  ["Product analytics", "For new app-use events, Roamly records a query-free page path linked to your account or a random browser identifier, along with device/browser category, language, and referring site domain. Trip UUIDs in analytics paths are replaced with a generic marker; full URLs and referrer paths are not recorded."],
  ["Location and reminders", "If you enable trip sensing and grant location permission, Roamly uses your location for trip activation and nearby itinerary features. Turning trip sensing off in Account stops future location updates and clears the last saved location. Push notifications require separate browser or phone permission; in-app reminders remain available if push is denied."],
